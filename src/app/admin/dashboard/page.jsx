...
import { Users, MapPin, MessageSquare, Star, TrendingUp, Eye } from 'lucide-react';
import { Card, CardContent, CardHeader, CardTitle } from '@/app/components/ui/card';
import { StatCard } from '@/app/components/admin/StatCard';
import { ActivityFeed } from '@/app/components/admin/ActivityFeed';
import { dashboardStats, activities, enquiryChartData, destinationChartData, destinations } from '@/app/data/mockData';
  ...
  return (
    ...
    <div className="space-y-6 p-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-1">Overview of your TripTribe platform</p>
      </div>
            ...
            <ResponsiveContainer width="100%" height={250}>
              <BarChart data={destinationChartData}>
                ...
                <Tooltip
                  ...
                  />
                <Bar dataKey="views" fill="hsl(var(--success))" radius={[4, 4, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </CardContent>
        </Card>
              ...
              <TableBody>
                {destinations.slice(0, 5).map((dest) => (
                  <TableRow key={dest.id}>
                    ...
                    <TableCell className="text-muted-foreground">{dest.region}</TableCell>
