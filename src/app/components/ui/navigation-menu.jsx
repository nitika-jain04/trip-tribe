      ...
      <NavigationMenuPrimitive.Viewport
        ...
        className={cn(
          "origin-top-center relative mt-1.5 h-[var(--radix-navigation-menu-viewport-height)] w-full overflow-hidden " +
            ...
            "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:zoom-out-95 data-[state=visible]:fade-in md:w-[var(--radix-navigation-menu-viewport-width)]",
          className,
        )}
        {...props}
      />
